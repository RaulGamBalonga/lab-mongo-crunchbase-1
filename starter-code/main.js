      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "5":
            ...
            db.collection('companies').find({ $or: [{ "founded_year": 2004, "founded_month": 4 }, { "founded_year": 2004, "founded_month": 5 }, { "founded_year": 2004, "founded_month": 6 }] }, { name: 1, _id: 0 }).sort({ founded_month: 1, founded_day: 1 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "11":
            ...
            db.collection("companies")
              .find({ name: "Facebook" }, { "relationships.person.permalink": 1 })
              .toArray((error, result) => {
                if (error) {
                  console.log(error);
                  rl.question(`\nType enter to continue: `, (answer) => {
